---
name: analyse
description: Run the full analysis pipeline against a codebase — documents it across all 10 doc types, then automatically runs the migration advisor once documentation is complete.
---
